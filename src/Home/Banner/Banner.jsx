...
const Banner = () => {
    return (
        <div className='bg-[#161420]  flex justify-center pb-40'>
        <Container>
            ...
            <div className='flex justify-center'>
               ...
               <button className="bg-gradient-to-r flex items-center gap-2  hover:from-teal-700 hover:to-blue-600 from-teal-600 to-blue-500 text-white font-semibold md:py-2 py-1 md:px-6 px-3 lg:text-xl text-lg mb-4 rounded-md shadow-md hover:shadow-lg">
